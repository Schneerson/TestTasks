...
public class FirstCase {
    ...
    public void Test() {
        ...
        driver.findElement(By.xpath(".//*[@id='number2Field']")).sendKeys("3");
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
        WebElement drop2 = driver.findElement(By.xpath(".//*[@id='selectOperationDropdown']"));
        Select sel2 = new Select(drop2);
        sel2.selectByVisibleText("Subtract");
        driver.findElement(By.xpath(".//*[@id='calculateButton']")).click();
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
        Assert.assertEquals("-1", driver.findElement(By.xpath(".//*[@id='numberAnswerField']")).getAttribute("value"));
        driver.quit();
    }
}